...
static ImageView UserImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserEmail=(TextView)header.findViewById(R.id.Uemail);
        UserName=(TextView)header.findViewById(R.id.Uname);
        ...
        UserImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent UserIntent=new Intent(getApplicationContext(),UserForm.class);

                startActivityForResult(UserIntent,10);
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.AddContacts:
                if (sharedpreferences.contains("PhonePreferences"))
                    sharedpreferences.edit().remove("PhonePreferences");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(requestCode==10)
        {
            ...
            String Uemail=data.getStringExtra("Uemail");

                byte[] bytesArray=data.getByteArrayExtra("picture");

            if(bytesArray==null && bmp==null){
               ...
               // editor.putString("myByteArray", bytesArray.toString(array));
